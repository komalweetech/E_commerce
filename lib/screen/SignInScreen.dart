              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: const Image(image: AssetImage("assets/images/ic_facebook.png"), height: 25, width: 25, fit: BoxFit.cover),
                  ),
                  const SizedBox(width: 16),
                  Container(
                    padding: const EdgeInsets.all(8),
                    decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.grey.withOpacity(0.2)),
                    child: const Image(image: AssetImage("assets/images/ic_google.png"), height: 25, width: 25, fit: BoxFit.contain),
                  ),
                ],
              ),
            ),
