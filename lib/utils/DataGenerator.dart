...
List<ShoppingModel> paymentList() {
  List<ShoppingModel> list = [];
  list.add(ShoppingModel(name: 'Payment Option', img: 'assets/images/ic_payment.png'));
  list.add(ShoppingModel(name: 'Credit/Debit Card', img: 'assets/images/ic_MasterCard.png'));
  list.add(ShoppingModel(name: 'Paypal', img: 'assets/images/ic_paypal.png'));
...
List<ShoppingModel> getSearchData() {
  List<ShoppingModel> list = [];
  list.add(ShoppingModel(name: 'Top & T-Shirt Collection', subtitle: '15% OFF', img: 'assets/images/ic_arrivals_4.jpg'));
  list.add(ShoppingModel(name: 'Top & T-Shirt Collection', subtitle: '40% OFF', img: 'assets/images/ic_arrivals_2.jpg'));
  list.add(ShoppingModel(name: 'Top & T-Shirt Collection', subtitle: '80% OFF', img: 'assets/images/ic_arrivals_3.jpg'));
  list.add(ShoppingModel(name: 'Top & T-Shirt Collection', subtitle: '95% OFF', img: 'assets/images/ic_arrivals_4.jpg'));
  list.add(ShoppingModel(name: 'Top & T-Shirt Collection', subtitle: '15% OFF', img: 'assets/images/ic_arrivals_5.jpg'));
